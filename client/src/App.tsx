...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/thc-edibles" component={CategoryPage} />
      <Route path="/microdosing-guides" component={CategoryPage} />
      <Route path="/cannabis-wellness" component={CategoryPage} />
      <Route path="/product-reviews" component={CategoryPage} />
      <Route path="/state-dispensary-guides" component={CategoryPage} />
