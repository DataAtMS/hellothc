...
const CATEGORY_SEO: Record<string, { metaTitle: string; metaDescription: string; h1: string; intro: string }> = {
  "thc-edibles": { metaTitle: 'THC Edibles | Hello from THC', metaDescription: 'Browse 3 articles about thc edibles on Hello from THC.', h1: 'THC Edibles', intro: 'Browse 3 articles about thc edibles on Hello from THC.' },
  "microdosing-guides": { metaTitle: 'Microdosing Guides | Hello from THC', metaDescription: 'Browse 3 articles about microdosing guides on Hello from THC.', h1: 'Microdosing Guides', intro: 'Browse 3 articles about microdosing guides on Hello from THC.' },
  "cannabis-wellness": { metaTitle: 'Cannabis Wellness | Hello from THC', metaDescription: 'Browse 3 articles about cannabis wellness on Hello from THC.', h1: 'Cannabis Wellness', intro: 'Browse 3 articles about cannabis wellness on Hello from THC.' },
  "product-reviews": { metaTitle: 'Product Reviews | Hello from THC', metaDescription: 'Browse 3 articles about product reviews on Hello from THC.', h1: 'Product Reviews', intro: 'Browse 3 articles about product reviews on Hello from THC.' },
  "state-dispensary-guides": { metaTitle: 'State Dispensary Guides | Hello from THC', metaDescription: 'Browse 3 articles about state dispensary guides on Hello from THC.', h1: 'State Dispensary Guides', intro: 'Browse 3 articles about state dispensary guides on Hello from THC.' }
};
...
export default function CategoryPage() {
  ...
  useEffect(() => {
    ...
    const pageUrl = 'https://hellothc.com/' + slug;
    ...
    script.textContent = JSON.stringify({
      ...
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": 'https://hellothc.com' },
