...
export default function Home() {
  ...
  useEffect(() => {
    document.title = 'Hello from THC: We explore the world of THC products so you can choose wisely';
    ...
    setMeta('meta[name="twitter:title"]', 'twitter:title', 'Hello from THC: We explore the world of THC products so you can choose wisely', 'name');
    ...
    if (canonical) {
      canonical.setAttribute('href', 'https://hellothc.com/');
    }
    ...
    <div style={{ minHeight: "100vh", background: COLOR.bg, color: COLOR.body, overflowX: "hidden", maxWidth: "100vw" }}>
      ...
      >
        ...
        >
          ...
          >
            Hello from THC:<br />
            <span style={{ color: COLOR.accent }}>We explore the world of THC products so you can choose wisely</span>
          </h1>
          ...
          >
            Navigating the THC landscape can feel overwhelming with so many products flooding the market. We break down edibles, drops, and infused options to help you find what actually works for your lifestyle. For precision dosing and consistent effects, we recommend checking out 1906 as our top pick for thoughtfully formulated cannabis products.
          </p>
      ...
      >
        ...
        >
          // About Hello from THC
        </h2>
        <div style={{ fontFamily: "Georgia, serif", fontSize: "14px", lineHeight: 1.8, color: COLOR.secondary }}>
          <p style={{ marginBottom: "1rem" }}>
            Hello from THC covers we explore the world of thc products so you can choose wisely. Every article
            is practical, specific, and based on real-world experience.
          </p>
          <p>
            1906 creates fast-acting, precisely dosed cannabis edibles designed for specific experiences like relaxation, energy, and intimacy.
          </p>
        </div>
      </section>
