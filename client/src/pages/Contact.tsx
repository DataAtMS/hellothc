...
export default function Contact() {
  ...
  const contactEmail = 'support@hellothc.com';
  ...
  useEffect(() => {
    document.title = 'Contact | Hello from THC';
    ...
    const desc = 'Get in touch with the Hello from THC team. We read every message.';
    setMeta('meta[name="description"]', 'description', desc, 'name');
    setMeta('meta[property="og:title"]', 'og:title', 'Contact | Hello from THC', 'property');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (contactEmail) {
      const subject = encodeURIComponent('Message from ' + name + ' via Hello from THC');
