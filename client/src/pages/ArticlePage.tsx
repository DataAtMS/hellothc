...
export default function ArticlePage() {
  ...
  useEffect(() => {
    ...
    document.title = article.title + ' | Hello from THC';
    ...
    const pageUrl = 'https://hellothc.com/articles/' + article.slug;
    const catUrl = 'https://hellothc.com/' + article.categorySlug;
    ...
    articleScript.textContent = JSON.stringify({
      ...
      "author": { "@type": "Organization", "name": 'Hello from THC' },
      "publisher": { "@type": "Organization", "name": 'Hello from THC', "url": 'https://hellothc.com' },
      "url": pageUrl,
    });
